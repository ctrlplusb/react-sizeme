...
var renderWrapper = function renderWrapper(WrappedComponent) {
  function SizeMeRenderer(props) {
    ...
    var toRender = renderPlaceholder
      ? (0, _preact.h)(Placeholder, { className: className, style: style })
      : (0, _preact.h)(WrappedComponent, _extends({}, renderProps, restProps))

    return (0, _preact.h)(ReferenceWrapper, { ref: explicitRef }, toRender)
  }
...
function sizeMe() {
  ...
  var refreshDelayStrategy =
    refreshMode === 'throttle' ? _throttle2.default : _debounce2.default
      ...
      _createClass(SizeAwareComponent, [
        ...
        },
        {
          ...
          value: function componentWillUnmount() {
            ...
            if (this.domEl) {
              ;(0, _resizeDetector2.default)(
                resizeDetectorStrategy,
              ).removeAllListeners(this.domEl)
              this.domEl = null
            }
          },
        },
        {
          ...
          value: function handleDOMNode() {
            ...
            this.domEl = found
            ;(0, _resizeDetector2.default)(resizeDetectorStrategy).listenTo(
              this.domEl,
